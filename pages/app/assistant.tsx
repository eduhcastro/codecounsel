import { IconUserCheck, IconCloudLightning, IconArchive, IconLogOut, Button } from "@supabase/ui";
...
function IntegrationPartnersPage() {
  ...
  function handleChange(e: React.ChangeEvent<HTMLSelectElement>) {
    if (e.target.value != "None") setLanguageEdit(e.target.value.toLowerCase());
  ...
  return (
    <>
      ...
      <Layout hideHeader={true} hideFooter={true}>
        ...
        <div className="grid space-y-2 md:gap-2 lg:grid-cols-4 lg:gap-2 lg:space-y-0 xl:gap-2" style={{ marginTop: "15px", display: "flex", flexDirection: "column" }}>

          <nav className="navbar dark:bg-scale-300 border-scale-300 dark:border-scale-400 rounded-2xl border bg-white p-6 drop-shadow-sm border-none">
            <ul className="navbar__menu">
              ...
              <li className="navbar__item">
                <Link href="/app/assistant">
                  <div className="navbar__link">
                    <IconUserCheck />
                    <span className="dark:bg-scale-300 bg-white">Code Assistant</span>
                  </div>
                </Link>
              </li>

              <li className="navbar__item">
                <a href="#" className="navbar__link"><IconCloudLightning /><span className="dark:bg-scale-300 bg-white">Ideias</span></a>
              </li>
              <li className="navbar__item">
                <a href="#" className="navbar__link"><IconArchive /><span>Strucute Assistent</span></a>
              </li>
              ...
              <li className="navbar__item">
                <Link href="/">
                  <div className="navbar__link">
                    <IconLogOut />
                    <span className="dark:bg-scale-300 bg-white">Exit</span>
                  </div>
                </Link>
              </li>
          ...
          <div id="Rendering">
            ...
            <p className="light:text-scale-300 text-white">This will take some time, please wait.</p>
          </div>

          <div className="lg:col-span-8 xl:col-span-9" id="Editor" style={{ marginLeft: "150px" }}>
          ...
          <div style={{ display: "flex" }}>
            ...
            <div style={{ marginLeft: "15px", width: "500px" }}>
              <Select onChange={handleChange}>
                <Select.Option value="None">Select a target</Select.Option>
          ...
          <div className="grid grid-cols-1 gap-5 lg:max-w-none lg:grid-cols-2 xl:grid-cols-4" id="Recepients" style={{ marginLeft: "150px" }}>
            ...
            <div className="space-y-4 itsnone animatedDiv" style={{ width: "350px" }}>
              <div className="grid grid-cols-2 gap-8 lg:grid-cols-1">
                <PartnerLinkBox
                  href={`#`}
