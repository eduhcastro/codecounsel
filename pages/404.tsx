 ...
 * Error404 Component
 *
 * This component shows a not found page with a 404 error message.
 */
  ...
  return (
    <Layout hideHeader hideFooter>
      <div className="relative mx-auto flex h-screen w-full flex-col items-center justify-center">
        ...
        <div className={`flex flex-col items-center justify-center space-y-6 transition ${
